...
begin
 ...
 if found then
  ...
  insert into public.group_session_bookings(id,session_id,player_name,player_age,parent_name,parent_email,parent_phone,emergency_contact,medical_notes,skill_level,status,payment_status,amount,expires_at,request_hash,checkout_description,checkout_service_type)
   values(b.id,b.session_id,b.player_name,b.player_age,b.parent_name,b.parent_email,b.parent_phone,b.emergency_contact,b.medical_notes,b.skill_level,b.status,b.payment_status,b.amount,b.expires_at,b.request_hash,b.checkout_description,b.checkout_service_type);
 end if;
