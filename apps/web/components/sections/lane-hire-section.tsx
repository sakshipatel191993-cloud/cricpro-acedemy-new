                ...
                <CardContent className="space-y-4">
                  <div className="flex justify-between items-center p-4 bg-background/60 rounded-lg border border-border/40">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Weekdays 9 AM–4 PM · Weekends 9–11 AM</p>
                    </div>
                  ...
                  <div className="flex justify-between items-center p-4 bg-background/60 rounded-lg border border-border/40">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Weekdays 4–10 PM · Weekends 11 AM–11 PM</p>
                    </div>
