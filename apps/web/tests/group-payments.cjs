...
(async()=>{
 ...
 const session={id:'class-1',title:'Masterclass',price:40,age_group:'11-15 years',session_kind:'masterclass',schedule:'Sunday 1–3 pm',current_players:0,max_players:12};
